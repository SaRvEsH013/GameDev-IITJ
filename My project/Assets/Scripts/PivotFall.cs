...
public class PivotFall : MonoBehaviour
{
    ...
    private void Update()
    {
        if (p2.transform.position.x >= button2.transform.position.x - 0.2f && p2.transform.position.x <= button2.transform.position.x + 0.2f && p2.transform.position.y <= button2.transform.position.y + 0.85f)
        {
