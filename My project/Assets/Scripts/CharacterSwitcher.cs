...
public class CharacterSwitcher : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        mainCamera.transform.position = Vector3.Lerp(mainCamera.transform.position, new Vector3(targetPosition.x, (p1.transform.position.y + p2.transform.position.y+0.5f) / 2f, Mathf.Min(p1.transform.position.z - distOfY - 1f, p1.transform.position.z -  2f)), switchSpeed * Time.deltaTime);
