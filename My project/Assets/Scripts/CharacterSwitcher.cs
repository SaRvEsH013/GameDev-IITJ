...
public class CharacterSwitcher : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        mainCamera.transform.position = Vector3.Lerp(mainCamera.transform.position, new Vector3(targetPosition.x, mainCamera.transform.position.y, mainCamera.transform.position.z), switchSpeed * Time.deltaTime);
    }
