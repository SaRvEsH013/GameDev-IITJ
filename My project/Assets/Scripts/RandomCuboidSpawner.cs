...
public class RandomCuboidSpawner : MonoBehaviour
{
    ...
    public Vector3 spawnPosition = new Vector3(-51.4f, 0.0104157329f, 1.05173063f); // Fixed spawn position
    public Vector3 moveDirection = Vector3.right; // Direction in which the cuboid will move (positive x direction)
